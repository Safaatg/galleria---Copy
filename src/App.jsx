...
import { GalleryContext } from "./context/GalleryContext"; // Assuming this file is in the same directory
    ...
    <GalleryContext.Provider value={GalleryData}>
      ...
      <Header></Header>
        <Routes>
          ...
          <Route path="/GalleryDetails/:galleryId/:name" element={<GalleryDetails />} />
        </Routes>
      </BrowserRouter>
